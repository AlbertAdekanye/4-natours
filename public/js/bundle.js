...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    marker.bindPopup("\n          <div class=\"map-popup\">\n            <strong>Day ".concat(loc.day, "</strong>\n            <span>").concat(loc.description, "</span>\n          </div>\n        "), {
      closeButton: false,
      autoClose: false,
      closeOnClick: false
    }).openPopup();
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          ...
          (0, _alert.showAlert)('error', ((_err$response = _t.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || _t.message || 'Something went wrong!');
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    var res, checkoutUrl, _err$response, _err$response2, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
        ...
        case 1:
          ...
          checkoutUrl = res.data.session.authorizationUrl;
        ...
        case 4:
          _context.p = 4;
          _t = _context.v;
          console.log(((_err$response = _t.response) === null || _err$response === void 0 ? void 0 : _err$response.data) || _t);
          (0, _alert.showAlert)('error', ((_err$response2 = _t.response) === null || _err$response2 === void 0 || (_err$response2 = _err$response2.data) === null || _err$response2 === void 0 ? void 0 : _err$response2.message) || 'Unable to start payment.');
        case 5:
          return _context.a(2);
      }
    }, _callee, null, [[0, 4]]);
